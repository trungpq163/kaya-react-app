        ...
        <div className="col-md-3 col-sm-6 col-xs-6">
            <div className="product-grid">
                ...
                <div className="product-content">
                    <h3 className="title">
                        <Link to={`${route}/${slugify(name)}`}>{name}</Link>
                    </h3>
                    <div className="price">
                        {format(price * 1000, {
                            decimalsDigits: 0,
...
export default connect(null, mapDispatchToProps)(CollectionItem2);
